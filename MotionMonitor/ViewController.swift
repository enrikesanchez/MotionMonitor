...
//  MotionMonitor
//
//  Created by esanchez on 4/27/19.
...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.gyroscopeLabel.text = String(format: "Rotation Rate:\n-----------------\n" +
                                           "x: %+.2f\ny: %+.2f\nz: %+.2f\n",
                                           0, 0, 0)
        self.accelerometerLabel.text = String(format: "Acceleration:\n---------------\n" +
                                             "Gravity x: %+.2f\t\tUser x: %+.2f\n" +
                                             "Gravity y: %+.2f\t\tUser y: %+.2f\n" +
                                             "Gravity z: %+.2f\t\tUser z: %+.2f\n",
                                             0, 0, 0, 0, 0, 0)
        self.attitudeLabel.text = String(format: "Attitude:\n----------\n" +
                                          "Roll: %+.2f\nPitch: %+.2f\nYaw: %+.2f\n",
                                          0, 0, 0)
